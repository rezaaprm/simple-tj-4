                            ...
                            <div class="carousel-caption">
                                <div class="p-3" style="max-width: 900px;">
                                    ...
                                    <div class="d-flex align-items-center justify-content-center">
                                        <a class="btn-hover-bg btn btn-primary rounded-pill text-white py-3 px-5" href="{{ route('public.map') }}">Coba Rute Sekarang</a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container-fluid search-bar position-relative" style="top: -50%; transform: translateY(-50%);">
            <div class="container">
                <div class="position-relative rounded-pill w-100 mx-auto p-4 text-center"
                    ...
                    <!-- Tombol Dashboard -->
                    @php
                        $dashboardRoute = route('login'); // default untuk guest
                        if (Auth::guard('admin')->check()) {
                    ...
                    <a href="{{ $dashboardRoute }}" class="btn btn-light rounded-pill py-2 px-4" style="font-weight: 600; color: #13357B;">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="destination-img">
                                            ...
                                            <img class="img-fluid rounded w-100"
                                                src="{{ file_exists(public_path('upload/destinasi/' . $item->gambar)) ? asset('upload/destinasi/' . $item->gambar) : asset('travela-1.0.0/img/' . $item->gambar) }}">
                            ...
                            @forelse ($galeri->flatten() as $item)
                                <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                                    <div class="gallery-item h-100">
                                        ...
                                        <img
                                            src="{{ file_exists(public_path('upload/galeri/' . $item->gambar)) ? asset('upload/galeri/' . $item->gambar) : asset('travela-1.0.0/img/' . $item->gambar) }}"
                                    ...
                                    <div class="row g-0 bg-white align-items-center">
                                        ...
                                        <div class="col-md-7">
                                            <div style="height: 450px;">
                                                <img src="{{ file_exists(public_path('upload/kolaborasi/' . $item->gambar)) ? asset('upload/kolaborasi/' . $item->gambar) : asset('travela-1.0.0/img/' . $item->gambar) }}"
