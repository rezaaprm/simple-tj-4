    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card card-outline card-success">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.kolaborasi.update', $data->id_kolaborasi) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-sm-2">
                                <a href="{{ route('admin.kolaborasi.index') }}" class="btn btn-danger btn-block">
                                    Kembali
                                </a>
                            </div>
                            <div class="col-sm-2">
