...
<div class="row">
    <div class="col-sm-12">
        <div class="card card-outline card-success">
            ...
            <div class="card-body">
                <form action="{{ route('info_statistik.destroy', $data->id_info_statistik) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('DELETE')
                    ...
                    <div class="row">
                        <div class="col-sm-2">
                            <a href="{{ route('info_statistik.index') }}" class="btn btn-block btn-danger">
