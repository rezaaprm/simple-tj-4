    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card card-outline card-success">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.galeri.update', $data->id_galeri) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-sm-2">
                                <a href="{{ route('admin.galeri.index') }}" class="btn btn-danger btn-block">
                                    Kembali
                                </a>
                            </div>
                            <div class="col-sm-2">
